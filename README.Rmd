...
EWR <- filter(weather, origin == "EWR")
  # look into ggplot notes
  ggplot(data = EWR, mapping = aes(x = day_of_year, y = mean_temp)) +
...
Construct a tidy data set to that give weather summaries for each (airport, day).  Use the total precipitation, minimum visibility, and average wind_speed.  
```{r}
```
